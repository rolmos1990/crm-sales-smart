                ...
                return (
                  <Link key={op.id} href={`/crm/oportunidades/${op.id}`}>
                    <div className={cn(
                      ...
                      {/* Arrow */}
                      <ExternalLink className="h-4 w-4 text-stone-300 dark:text-stone-600 group-hover:text-stone-400 dark:group-hover:text-stone-400 flex-shrink-0 transition-colors" />
                    </div>
                  </Link>
                );
              })}
