...
export const ConfiguracionEmpresaSchema = z.object({
  nombreEmpresa: z.string().max(200).optional().or(z.literal("")),
  ...
  telefonoPrincipal: z.string().max(20).optional().or(z.literal("")),
  whatsappPrincipal: z.string().max(20).optional().or(z.literal("")),
